...
int main(int argc, char **argv)
{
  try {
	...
	label_list.push_back("3");
	label_list.push_back("4");
	label_list.push_back("5");
	
	label_list.push_back("6");
	label_list.push_back("7");
	label_list.push_back("8");
    ...
    if(algo=="deep"){
		classifier = new DeepNet(label_list);
	}
